...
## Project Structure
    ...
    ├── ot_transtar_integra_32561  # Django project configurations
...
1. Clone this repo and `cd ot_transtar_integra_32561`
...
2. Clone this repo and `cd ot_transtar_integra_32561`
